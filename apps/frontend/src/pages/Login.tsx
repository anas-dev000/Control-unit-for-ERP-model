    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-4 font-sans">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2">Simplify your multi-tenant accounting</p>
        </div>
        ...
        <p className="text-center text-slate-400 mt-8 text-xs font-medium uppercase tracking-widest">
